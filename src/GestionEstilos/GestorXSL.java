...
public class GestorXSL 
{
    public void crearHTML() throws FileNotFoundException, TransformerConfigurationException, TransformerException, IOException
    {
        ...
        Source datos = new StreamSource("EmpleadosDom.xml");
        Result result = new StreamResult(fos);
        Transformer transformer= TransformerFactory.newInstance().newTransformer(estilos);
        transformer.transform(datos, result);
        fos.close();
        
        System.out.println("La página html ha sido creada correctamente.");
    }    
}
